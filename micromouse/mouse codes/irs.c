...
uint16_t readIR(IR ir)
{
	...
	switch(ir)
	    {
	        ...
	        case IR_FRONT:
	            ...
	            break;
	        case IR_RIGHT:
	            HAL_GPIO_WritePin(FrontEmitter_GPIO_Port, FrontEmitter_Pin, GPIO_PIN_SET);
	            break;
	        default:
	            return 0;
	    }
	...
	switch(ir)
		{
		     	case IR_LEFT:
		            readValue = analogRead(IR_LEFT);
		            break;
		        case IR_FRONT:
		        	readValue = analogRead(IR_FRONT);
		        	break;
		        case IR_RIGHT:
		        	readValue = analogRead(IR_RIGHT);
		        	break;
		        default:
		            return 0;
		}
	switch(ir)
	    {
	        ...
	        case IR_FRONT:
	            ...
	            break;
	        case IR_RIGHT:
	            HAL_GPIO_WritePin(FrontEmitter_GPIO_Port, FrontEmitter_Pin, GPIO_PIN_RESET);
	            break;
	        default:
	            return 0;
	    }
